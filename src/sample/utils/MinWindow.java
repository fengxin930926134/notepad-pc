...
public class MinWindow {
    ...
    private static final java.awt.MenuItem showItem;
    private static final java.awt.MenuItem exitItem;
    ...
    private MinWindow(){
        try {
            ...
            //鼠标移到系统托盘,会显示提示文本
            trayIcon.setToolTip("记得做");
            tray.add(trayIcon);
        } catch (Exception e) {
            //系统托盘添加失败
            System.err.println(Thread.currentThread().getStackTrace()[ 1 ].getClassName() + ":系统添加失败");
        }
    }
